...
{
    public sealed class SiteUserLoginHistory : Entity
    {
        public SiteUserLoginHistory(Guid userId, string ipAddress, string userAgent, bool isSuccessful)
        {
            UserId = userId;
            IpAddress = ipAddress;
            UserAgent = userAgent;
